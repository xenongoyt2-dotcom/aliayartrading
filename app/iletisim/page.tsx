        ...
        <div className="grid md:grid-cols-2 gap-8 mb-12">
              ...
              <CardContent className="p-6">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground mt-2">Pazartesi - Cuma: 08:00 - 18:00</p>
                    <p className="text-sm text-muted-foreground mt-2">Cumartesi: 08:00 - 14:00</p>
                  </div>
                </div>
              </CardContent>
            </Card>
          ...
          <div>
            <Card className="overflow-hidden h-full">
              <CardContent className="p-0 h-full min-h-96">
                <iframe
